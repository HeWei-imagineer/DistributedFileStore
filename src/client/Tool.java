...
public class Tool {
	...
	*/
	...
	//by HW
	static public String FindFolder(int port, Set<storageNode>nodeInformation) {
		Iterator<storageNode> iterator = nodeInformation.iterator();
		while(iterator.hasNext()){
			storageNode node = iterator.next();
			if(node.NodePort==port){
				return node.RootFolder.getName();
			}
		}
